...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="وين تروح">
    <meta name="theme-color" content="#f97316">
    
    <title>تكسي وين تروح</title>
...
<div id="passengerScreen" class="hidden">
    <div class="header">
        <div style="font-weight:900; font-size:22px; color:#f97316;">🚕 وين تروح</div>
        <div id="passengerNameDisp" style="font-weight:bold; color:#1e293b;"></div>
    </div>
    ...
    <div id="passengerToast" class="toast hidden"></div>
</div>

<div id="driverScreen" class="hidden">
    <div class="header">
        <div style="font-weight:900; font-size:22px; color:#0f172a;">🚖 نظام الكابتن</div>
        <div style="background:#22c55e; color:white; padding:5px 12px; border-radius:20px; font-size:12px;">متصل</div>
    </div>
    <div style="padding: 15px;">
        <div id="driverMap"></div>
        <div class="orders-list">
            <h3 style="margin-bottom:15px; color:#1e293b;">📋 طلبات قريبة</h3>
            <div id="driverOrders">
                <div class="order-card">
                    <div style="font-weight:bold;">📍 المنصور ← الكرادة</div>
                    <div style="font-size:14px; color:#64748b; margin:5px 0;">💰 السعر: 5,500 دينار | 👤 العميل: علي</div>
                    <button class="accept-btn" onclick="acceptRide(this)">✅ قبول الرحلة</button>
                </div>
                <div class="order-card">
                    <div style="font-weight:bold;">📍 الجادرية ← الدورة</div>
                    <div style="font-size:14px; color:#64748b; margin:5px 0;">💰 السعر: 4,000 دينار | 👤 العميل: سارة</div>
                    <button class="accept-btn" onclick="acceptRide(this)">✅ قبول الرحلة</button>
                </div>
            </div>
            <button class="back-btn" onclick="location.reload()">↩️ تسجيل الخروج</button>
        </div>
    </div>
</div>
        ...
        setTimeout(() => {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(p => {
                    ...
                    if(divId === 'map') document.getElementById('pickupInput').value = "موقعي الحالي";
                });
            }
        }, 200);
    }
